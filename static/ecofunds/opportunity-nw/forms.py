...
class OpportunityAdvancedSearchForm(AdvancedSearchForm):
    ...
    s_opportunity = forms.CharField(label=_('Opportunity'), widget=forms.TextInput(attrs={'class':'combo','placeholder': _('Enter the name of an opportunity')}))
    s_all_opportunities = forms.BooleanField(label=_('All opportunities'), widget=forms.CheckboxInput(attrs={'class':'check', 'value': 0}))

    s_country = forms.CharField(label=_('Country'), widget=forms.TextInput(attrs={'class':'combo','placeholder': _('Enter the name of a country')}))
    s_state = forms.CharField(label=_('State'), widget=forms.TextInput(attrs={'class':'combo','placeholder': _('Enter the name of a state')}))

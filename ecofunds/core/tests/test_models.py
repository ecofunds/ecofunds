...
class OrganizationFilterTest(TestCase):
    def setUp(self):
        ...
        self.org1 = m('Organization', name=u'Fundo', acronym='Funbio',
                      type=t1, country=c1, state=l1, desired_location_lat=1,
                      desired_location_lng=1, phone_country_prefix='55',
                      phone_local_prefix='21', phone_number='22222222')
    ...
    def test_formated_phone_number_property(self):
        self.assertEqual('55 21 22222222', self.org1.formated_phone_number)

    def test_kind_property(self):
        self.assertEqual('Fundo Ambiental', self.org1.kind)

    def test_location_name_property(self):
        self.assertEqual('Rio de Janeiro', self.org1.location_name)

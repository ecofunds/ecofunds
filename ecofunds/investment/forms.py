...
class InvestmentForm(ModelForm):
    ...
    investor_project = forms.ChoiceField(choices=y_n_choices,widget=forms.RadioSelect(renderer=MyRadioFieldRenderer), label=_("Is the investment an action of an investor project?"),initial='False',required=False)
    r_project = forms.ChoiceField(choices=y_n_choices,widget=forms.RadioSelect(renderer=MyRadioFieldRenderer), label = _("Is the investment direct to a recepient project?"),initial='False',required=False)
    ...
    recipient_entity = make_ajax_field(Investment,'recipient_entity','project',help_text=_('Enter text to search'),label=_('Recipient Project'), required = False)
    funding_entity = make_ajax_field(Investment,'funding_entity','project',help_text=_('Enter text to search'),label=_('Investor Project'), required = False)
